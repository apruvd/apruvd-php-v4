...
/**
 * Class UpsertTransactionResponse
 * @package Apruvd\V4\Responses
 */
class UpsertTransactionResponse extends APIResponse{
    ...
    /**
     * @var string $user_agent "User-Agent" header
     */
    ...
    /**
     * @var string|float|double|int $shipping_cost
     */
    public $shipping_cost = null;
    /**
     * @var string $shipping_cost_currency
     */
    ...
    /**
     * @var \DateTime|string $timestamp YYYY-MM-DD HH:MM[:ss[.uuuuuu]][TZ]
     */
    ...
    /**
     * @var integer $review_priority
     */
    public $review_priority = null;
    /**
     * @var integer $escalation_level
     */
    public $escalation_level = null;

    /**
     * UpsertTransactionResponse constructor.
    ...
    public function __construct($props = null)
    {
        ...
        if(!empty($props->cart_contents)){
            ...
            foreach($props->cart_contents as $content){
                $contents[] = new CartContent($content);
            }
